...
INT_IOCRB: ; SUBRUTINA DE INTERRUPCIÓN EN PORTB
    ...
    BTFSS PORTB, BINC ; REVISAR SI EL BIT DEL PRIMER BOTON EN ((PORTB) and 07Fh), 0 HA CAMBIADO A 0
    INCF PORTA ; SI HA CAMBIADO A 0 (HA SIDO PRESIONADO) INCREMENTAR CUENTA EN PORTA
    BTFSS PORTB, BDEC ; REVISAR SI EL BIT DEL SEGUNDO BOTON EN ((PORTB) and 07Fh), 1 HA CAMBIADO A 0
